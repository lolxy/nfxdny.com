...
class AdminPostController extends AdminbaseController {
	...
	private  function _lists($status=1){
		$term_id=0;
		$termid=$this->terms_model->field('term_id')->where(array("taxonomy"=>"article"))->select();
    	...
    	$terms = $this->terms_model->where(array('taxonomy'=>'article'))->order(array("term_id in ($term_id)"))->getField("term_id,name",true);
